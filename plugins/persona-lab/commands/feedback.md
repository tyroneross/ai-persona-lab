---
name: feedback
description: Report a bug or send feedback about the persona-lab plugin
---

# Report persona-lab feedback

File the user's report as a GitHub issue on `tyroneross/ai-user-personas`. Issues are this plugin's
...
```bash
gh issue create --repo tyroneross/ai-user-personas \
...
5. If `gh` is missing or unauthenticated, do not fail — print the URL so the user
   can open it in a browser: https://github.com/tyroneross/ai-user-personas/issues/new
