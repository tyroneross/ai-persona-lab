...
export function createBriefPlan(positional, flags) {
  ...
  return {
    ...
    durable_review: 'For an auditable source review, freeze explicit files, create a run with --manifest, then use persona run packet <run_id> <persona_id> --owns <scope>. The host executes the saved packet.',
